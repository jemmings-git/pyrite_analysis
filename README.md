 ...
 * `SGP_Fe_ferruginous_fractions_strat.csv` - the fraction of ferruginous vs. euxinic conditions on an age (1 Ma bin), long-lat basis *and* stratigraphic name, derived from [SGP Fe-speciation data](http://sgp-search.io/). These data were matched to the pyrite TE record. 
